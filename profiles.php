    ...
    <div id="contents">
        ...
        <div style="width: 950px;height: 600px;">
            <div style="width: 250px;height: 600px;  float:left; text-align:center;">
                ...
                <form action="uploadImage.php?id=<?php echo $_SESSION['userId'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div style="width: 700px;height: 600px;  margin-left:250px;">
                <form action="updateprofile.php?id=<?php echo $_SESSION['userId'] ?>" method="POST">
