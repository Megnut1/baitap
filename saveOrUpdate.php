...
?>
	<div id="contents"> 
        ...
        <div class="section">
			<?php if(!isset($_GET['blog_id'])){ ?>
				<form action="saveblog.php" method="POST" class="message">
	...
	filebrowserUploadUrl: 'public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files'
					...
					<input type="submit" value="Lưu" name="up"/>
				</form>
			<?php }else{ 
				$blogId = $_GET['blog_id'];	
			...
			?>
				<form action="publicPost.php?blog_id=<?php echo $blogId ?>" method="POST" class="message">
